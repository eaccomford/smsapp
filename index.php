<div style="height: 90vh">
    <?php include('includes/head.php') ?> <section class="tm-margin-large-top">
        <div class="uk-container uk-text-center">

            <p class="uk-margin-remove-bottom tm-overtitle uk-margin-top uk-text-uppercase letter-spacing-l" data-uk-scrollspy="cls: uk-animation-slide-bottom-medium">Welcome to STAK Kiosk</p>
            <h1 class="uk-margin-small-top uk-heading-hero" data-uk-scrollspy="cls: uk-animation-slide-bottom-medium; delay: 40">How can we help?</h1>
            ...
            <div class="uk-grid-medium uk-child-width-1-3@m uk-grid-small uk-grid-match tm-margin-large-top uk-text-center" data-uk-grid data-uk-scrollspy="cls: uk-animation-slide-bottom-medium; delay: 80">
                ...
                <div>
                    <a href="policy-status" class="uk-card uk-card-box uk-card-body uk-box-shadow-medium uk-border-rounded">
                        <span class="uk-icon-forder uk-border-rounded"><span data-uk-icon="icon: nut; ratio: 2"></span></span>
                        <p>Check Policy Status</p>
                    </a>
                </div>
                <div>
                    <a href="buy-product?id=3&name=Claim-Request" class="uk-card uk-card-box uk-card-body uk-box-shadow-medium uk-border-rounded">
                        <span class="uk-icon-forder uk-border-rounded"><span data-uk-icon="icon: plus-circle; ratio: 2"></span></span>
...
<footer class="uk-section tm-primary-color-dark uk-light uk-text-center">
    <div class="uk-container">
        ...
        <div class="uk-margin-medium tm-text-xsmall uk-text-meta copyright">Powered by <a href="https://shrinqghana.com/">Shrinq</a></div>
