        ...
        <div style="margin-top: -4em">
            <form id="save_productfrm"
                ...
                <div class="uk-margin-large-bottom">
                    <label class="uk-form-label uk-margin-small-bottom" for="form-stacked-text">Customer Name</label>
                ...
                <div class="uk-margin-large-bottom">
                    <label class="uk-form-label uk-margin-small-bottom" for="form-stacked-text">Mobile Number</label>
                    <div class="uk-form-controls">
