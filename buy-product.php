...
<div style="height: 90vh; margin-bottom: 5rem">
    <section class="tm-margin-large-top" id="elementID" style="padding-bottom: 1em">
        <div class="uk-container">
            ...
            <div class="uk-grid-medium uk-child-width-1-3@m uk-grid-small uk-grid-match tm-margin-large-top uk-text-center" data-uk-grid data-uk-scrollspy="cls: uk-animation-slide-bottom-medium; delay: 80" style=" display: flex; justify-content:center">
                <div style="text-align:center;display: none; margin-bottom: 3rem" id="mainmenu">
                    <a href="index" class="uk-card uk-card-box uk-card-body uk-box-shadow-medium uk-border-rounded">
                        <span class="uk-icon-forder uk-border-rounded"><span data-uk-icon="icon: home; ratio: 2"></span></span>
            ...
            <div style="margin-top: -8em" id="formdiv">
                <form id="save_productfrm" class="uk-form-stacked uk-margin-xlarge-top uk-margin-xlarge-bottom tm-form-contact">
                    <div class="uk-margin-large-bottom">
                        <label class="uk-form-label uk-margin-small-bottom" for="form-stacked-text">Customer
                            Name</label>
                        <div class="uk-form-controls">
                            <input class="uk-input uk-form-large tm-form-xlarge uk-border-rounded" id="customer_name" id="form-name" type="text" placeholder="Enter your name">
                    ...
                    <div class="uk-margin-large-bottom">
                        <label class="uk-form-label uk-margin-small-bottom" for="form-stacked-text">Mobile
                            Number</label>
                        <div class="uk-form-controls">
                            <input id="mobile" class="uk-input uk-form-large tm-form-xlarge uk-border-rounded" id="form-email" type="number" placeholder="Enter Mobile umber">
                        </div>
                    ...
                    <div class="uk-margin-large-bottom">
                        ...
                        <div class="uk-form-controls">
                            <input id="email" class="uk-input uk-form-large tm-form-xlarge uk-border-rounded" id="form-email" type="email" placeholder="Enter your email">
                        </div>
                        <div class="email"></div>
                    </div>
                    <div class="uk-margin-large-bottom">
                        <label class="uk-form-label uk-margin-small-bottom" for="form-stacked-text">Notification
                            Type</label>
                        <div class="uk-form-controls">
                            <input value="SMS" id="typesms" type="radio" checked name="notification_type" style="transform: scale(2); "> SMS
                            <input value="EMAIL" id="typeemail" type="radio" name="notification_type" style="transform: scale(2); "> Email
                        </div>
                    </div>
                    <div class="uk-text-left">
                        <button class="tm-button tm-button-xlarge" id="save_product" name="send">Submit</button>
                    </div>
                    <div id="loading" style="display: none; background: white; padding: 1em; color: green; font-size: 21px; font-weight: bold; text-align:center">
                        Processing Request...
                    </div>
                </form>
